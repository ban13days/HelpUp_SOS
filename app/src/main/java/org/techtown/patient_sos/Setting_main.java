...
public class Setting_main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //환자선택화면 열기 버튼
        ImageButton img3 = findViewById(R.id.button2);
        ...
        //메세지 설정화면
        ImageButton img4 = findViewById(R.id.button3);
        ...
        //스케줄 설정화면
        ImageButton img11 = findViewById(R.id.button4);
        ...
        //이용안내
        /*
        Button img11 = findViewById(R.id.button4);
        img11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Setting_main.this, Setting_Schedule.class);
